        ...
        <div className="flex flex-col">
          ...
          <div>
            <button
              ...
              className="mt-5 text-mainDarkText text-md font-semibold bg-mainButton py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-500 transform-gpu hover:scale-110 "
            >
              Receipt
            </button>
          </div>
